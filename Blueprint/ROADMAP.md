...
Estado y dirección del proyecto. Para el detalle técnico de cada decisión, ver [`DECISIONS.md`](./DECISIONS.md). Para ideas sin madurar, ver [`Ideas.md`](./Ideas.md).
...
- [x] `AuroraEqualizerProvider` — Nivel A: control por presets vía EasyEffects (CLI, `easyeffects -l <preset>`)
