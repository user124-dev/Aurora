...
- Componentes visuales *también* llevan el prefijo `Aurora`, en `Components/`: `AuroraSpectrum.qml`, `AuroraControls.qml`, `AuroraCover.qml`, `AuroraInfo.qml` (ver `CONVENTIONS.md` → Naming).
